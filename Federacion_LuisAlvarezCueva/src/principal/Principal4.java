...
public class Principal4 {
	...
	public static void main(String[] args) {
		...
		// System.out.println(Datos.COLEGIADOS[0].toString());
	...
	private static void mostrarSubmenuGestionMedallas(int elecc) {
		...
		case 2: // opción 1.1.2
			...
			do {
				System.out.println("Seleccione el tipo de medalla:");
				...
				switch (sc.nextInt()) {
				case 1:
					System.out.println("Introduzca pureza mínima");
					purMini = Utilidades.leerFloat();
					System.out.println("Introduzca pureza máxima");
					purMaxi = Utilidades.leerFloat();
					System.out.println("Introduzca la fecha mínima");
					fechMini = Utilidades.leerFecha();
					System.out.println("Introduzca la fecha máxima");
					fechMaxi = Utilidades.leerFecha();
					System.out.println("¿Ha sido asignada?");
					asig = Utilidades.leerBoolean();
					
					for(Oro i: Datos.OROS) {
						if(purMini <= i.getPureza() && i.getPureza() <= purMaxi 
								&& i.getFecha().isBefore(fechMaxi) && i.getFecha().isAfter(fechMini)
								&& i.isAsignada() == asig) {

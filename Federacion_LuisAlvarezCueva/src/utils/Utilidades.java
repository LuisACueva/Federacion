...
public class Utilidades {
	...
	/**
	 * Esta función permite introducir por teclado un valor float,
	 * en caso de que el valor introducido sea válido.
	 * En caso de que el valor no sea válido obligará al usuario a introducir otro valor,
	 * hasta introducir un valor válido.
	 * 
	 * @return valor introducido por teclado, en formato float.
	 */

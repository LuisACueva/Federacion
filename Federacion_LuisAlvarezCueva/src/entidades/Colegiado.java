...
public class Colegiado {
	...
	/**
	 * Este método, aplicado a un objeto de tipo Colegiado, transforma 
	 * dicho objeto en una cadena de caracteres.
	 * 
	 * @return Una cadena de caracteres con los datos del colegiado.
	 */
	@Override
	public String toString() {
		return id + ". " + persona.getNombre() + " (" + persona.getNifnie().mostrar() + ") nacido el " + persona.getFechaNac().getYear() + ", tlfno: " + persona.getTelefono() + " CAT=" + this.getCategoria();
	}
